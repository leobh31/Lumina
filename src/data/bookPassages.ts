  ...
  b5: [
    {
      ...
      text: "Ao amanhecer, dize a ti mesmo: encontrar-me-ei hoje com o intrometido, com o ingrato, com o insolente, com o ardiloso, com o invejoso, com o antissocial.\n\nTodas estas ofensas lhes ocorrem por ignorância do que é o bem e o mal. But eu, que vi a natureza do bem, que é o belo, e a do mal, que é o vergonhoso, e a do próprio pecador, que é meu parente, não posso ser lesado por nenhum deles, pois ninguém me cobrirá de vergonha.\n\nTambém não posso irar-me contra o meu parente, nem odiá-lo. Pois fomos criados para cooperar, como os pés, as mãos, as pálpebras, as fileiras de dentes superiores e inferiores. Agir uns contra os outros, portanto, é contrário à natureza.\n\nAcolhe cada hora com a determinação firme de um romano e de um homem de caráter, realizando a tarefa que tens em mãos com dignidade precisa, afeição sincera, liberdade e justiça."
    },
    {
      pageNumber: 2,
      chapterTitle: "Da Impermanência",
      text: "Lembra-te sempre de quão rápido todas as coisas passam e desaparecem, tanto os próprios seres quanto os acontecimentos. A existência é como um rio em fluxo perpétuo, as forças estão em constante mudança e as causas em infinitas variações.\n\nApenas a razão calma nos protege. Controla e domestica os teus impulsos, aceita o destino com altivez e serve aos teus semelhantes sem vaidade.\n\nConsidera a imensidão do tempo que jaz atrás de ti e o abismo infinito do futuro que se abre à tua frente. Diante desta imensidão, qual a diferença entre aquele que viveu três dias e o que viveu três gerações?\n\nTudo o que vês será transformado num piscar de olhos pela natureza que governa o Todo, e outras coisas nascerão de suas cinzas, mantendo o universo eternamente jovem."
    }
  ],
  b6: [
    {
      ...
      text: "Muitos anos depois, diante do pelotão de fuzilamento, o Coronel Aureliano Buendía havia de recordar aquela tarde remota em que seu pai o levou para conhecer o gelo. Macondo era então uma aldeia de vinte casas de barro e taquara, construídas à margem de um rio de águas diáfanas que se precipitavam por um leito de pedras polidas, brancas e enormes como ovos pré-históricos.\n\nO mundo era tão recente que muitas coisas careciam de nome e, para mencioná-las, precisava-se apontar com o dedo.\n\nTodos os anos, pelo mês de março, uma família de ciganos esfarrapados plantava a sua tenda perto da aldeia e, com um grande alvoroço de apitos e timbales, dava a conhecer as novas invenções dos sábios de terras distantes.\n\nJosé Arcadio Buendía, cuja imaginação desregrada ia sempre mais longe que o engenho da natureza, pensou que era possível servir-se daquela invenção magnética para desenterrar o ouro da terra profunda."
    },
    {
      pageNumber: 2,
      chapterTitle: "A Solidão de Buendía",
      text: "José Arcadio Buendía passava horas trancado no laboratório de alquimia, tentando extrair ouro da terra ou encontrar a passagem para as grandes invenções de Melquíades.\n\nBut o maior perigo era o vento da solidão que sobrava sobre as telhas da grande casa. Naquela solidão fantástica, cada herdeiro do nome Buendía estava condenado a repetir os erros do passado, amando e odiando na mais absoluta falta de testemunhas reais.\n\nCom o tempo, a casa foi se enchendo de fantasmas benévolos que caminhavam pelos corredores nas tardes de calor, misturando as lembranças dos vivos com os sussurros inconsoláveis dos mortos.\n\nAurelia Buendía compreendeu que o tempo não passava de forma retilínea, mas girava em círculos concêntricos ao redor da imensa árvore de jasmim plantada no centro do quintal."
    }
  ],
  b7: [
    {
