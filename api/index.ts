...
app.post("/api/gemini/explain", async (req, res) => {
  try {
    ...
    if (mode === "meaning") {
      ...
      Explique de forma altamente simplificada, rápida e acessível o significado desse pensamento para um leitor leigo or iniciante. Use uma analogia cotidiana curta, retire qualquer jargão técnico e resuma a mensagem fundamental de forma ultraobjetiva em no máximo 2 parágrafos breves.`;
